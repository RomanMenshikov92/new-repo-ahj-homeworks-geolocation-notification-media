...
export default class TimelineDOM {
  ...
  drawUI() {
    ...
    this.container.innerHTML = `
      <header class="header">
        <p>Geolocation, Notification, Media</p>
      </header>
        ...
        <form class="popup close">
          <div class="popup-container">
            ...
            <div class="popup-buttons">
              ...
              <button class="popup-btn" data-id="popup-cancel" type="cancel">Отмена</button>
            </div>
          </div>
        </form>
      </div>
  ...
  */
  renderMessage(message) {
    ...
    /* остановка метода, если тип другой */
    ...
    /*
    *  если тип поста аудио или видео, то создаётся объект медиа и включается контроль,
    *  устанавливается ссылка, задаётся класс и вставляется в тело поста
    */
    ...
    *  а потом вставка блока с датой, телом и геолокации в пост
    */
    ...
    /* вставка контейнера поста в ленту и прокрутка ленты вверх */
  ...
  /*
  *  кнопка отправки текстового сообщения, передаёт введённый текст
  ...
  *  передаёт введённую вручную геолокации и тип нажатой кнопки
  ...
  */
  ...
  /*
  *  метод для формы введения геолокации
  *  передаёт введённую вручную геолокации
  ...
  */
  ...
  /*
  * создаёт окно предпросмотр записи видео
  */
